 ...
 * @author philippos
 */
@WebServlet(urlPatterns = {"/get_user_posts_from_db"})
public class get_user_posts_from_db extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            System.out.println("I am in get user post  servlet!!!!");
            ...
            user_ten_recent_posts = access_post_db.getTop10RecentPostsOfUser(who_is_logged_in);
            System.out.println("????????????????????????????");
            System.out.println(user_ten_recent_posts);
            Post first_post = user_ten_recent_posts.get(0);
            //out.print();
            String user_ten_posts = "{";
            user_ten_posts += "\"username\": \""+who_is_logged_in+"\" ";
