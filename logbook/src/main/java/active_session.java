 ...
 * @author philippos
 */
@WebServlet(urlPatterns = {"/active_session"})
public class active_session extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            System.out.println("I am in active ession!!!!");
         ...
         Cookie ck=new Cookie("name",name);  
           ...
           ck=new Cookie("name",name2);  
            ck.setMaxAge(60*10);
            response.addCookie(ck);
              String answer = "{";
              answer += "\"all_good\": \""+"fine"+"\" ";
              answer += "}";
              out.print(answer);
