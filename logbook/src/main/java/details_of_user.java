 ...
 * @author philippos
 */
@WebServlet(urlPatterns = {"/details_of_user"})
public class details_of_user extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            System.out.println("I am in my details_of_user servlet!!!!");
            String username = request.getParameter("username");
            UserDB access_db = new UserDB();
            User get_user = access_db.getUser(username);
            // Get user data with gets methods
            ...
            String registered_since = get_user.getRegisteredSince();
            
            String user_data_from_db = "{";
            user_data_from_db += "\"username\": \""+username+"\" ";
            user_data_from_db += ",";
            ...
            user_data_from_db += ",";
            user_data_from_db += "\"registered_since\": \""+registered_since+"\" ";
            user_data_from_db += "}";
