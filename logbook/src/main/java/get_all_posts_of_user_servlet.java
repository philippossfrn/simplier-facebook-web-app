 ...
 * @author philippos
 */
@WebServlet(urlPatterns = {"/get_all_posts_of_user_servlet"})
public class get_all_posts_of_user_servlet extends HttpServlet {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            for(int i=0;i<all_posts_from_db.size();i++){
                ...
                if ( who_is_logged_in.equals(all_posts_from_db.get(i).getUserName()) ){
                    ...
                    //User posts deleted
                    access_post_db.deletePost(all_posts_from_db.get(i).getPostID());
                    total_user_posts++;
                }
            }
            all_user_posts += ",";
