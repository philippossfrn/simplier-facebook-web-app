 ...
 * @author philippos
 */
@WebServlet(urlPatterns = {"/add_user_to_db_servlet"})
public class add_user_to_db_servlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            new_user.setRegisteredSince(current_date);
            ...
            new_user_db_instance.addUser(new_user);
