 ...
 */
function handle_okay_to_update_servlet_response(response_from_valid_servlet) {
    ...
    document.getElementById('all_good_user_created_msg').innerHTML = '';
        ...
        // It's time to update user in database
        document.getElementById('errors_from_validation_servlet_msg').innerHTML = '';
        ...
        //call update servlet
        send_xmlhttp_request('POST','update_user?'+data,data,handle_update_user_servlet_response);
    }
}
